...
class Gallery extends React.Component{
	...
	var lightboxImages = [];
		...
		if (this.props.disableLightbox){
            ...
            <div onClick={this.props.requestImageDetail.bind(this, this.props.photos[k].id)} className="img-container" key={k} style={style}>
              ...
              <div className="img-footer fbc">
                <div className="ibm">
                  <img className="avatar-img ibm" src={this.props.photos[k].avatar} alt=""/>
                  <span className="avatar-title white ibm">{this.props.photos[k].email}</span>
                </div>
                <div className="ibm">
