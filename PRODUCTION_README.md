...
Although this is less essential functionality, I also plan to implement messaging between Stellar Pixels users.  To do this, I will use WebRTC so that notifications of messages happens seamlessly.  